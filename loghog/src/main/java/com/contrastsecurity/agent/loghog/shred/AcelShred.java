...
public class AcelShred extends Shred {
    ...
    public AcelShred() {
        super(new SqlTableBase(ACEL_TBL_NAME, ACEL_TBL_CREATE_SQL, ACEL_TBL_INDEX_SQLS, ACEL_TBL_COLUMNS),
    ...
    public Object[] transformValues(int line, String entry, String patternId, Map<String, Object> extractedVals) {
        ...
        return new Object[] { line, patternId, classname, packageName, extractedVals.get("application"), extractedVals.get("location") };
    }
    ...
    public static final String ACEL_TBL_CREATE_SQL =
            "create table acel(" +
                    ...
                    "application text," +
                    "location text)";
    public static final List<String> ACEL_TBL_INDEX_SQLS = Arrays.asList(
    ...
    public static final ShredEntrySelector ENTRY_SELECTOR =
            new ShredEntrySelector(ENTRY_SIGNATURE);
