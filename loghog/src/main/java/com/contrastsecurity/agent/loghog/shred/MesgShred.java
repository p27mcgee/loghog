...
public class MesgShred extends Shred {
    ...
    public MesgShred() {
        super(new SqlTableBase(MESG_TBL_NAME, MESG_TBL_CREATE_SQL, MESG_TBL_INDEX_SQLS, MESG_TBL_COLUMNS),
                new SqlTableBase(CONTINUATIONS_TBL_NAME, CONTINUATIONS_TBL_CREATE_SQL, CONTINUATIONS_TBL_INDEX_SQLS, CONTINUATIONS_TBL_COLUMNS),
...
""";
    public static final List<String> MESG_TBL_INDEX_SQLS = Arrays.asList(
