...
public class AmqpShred extends Shred {
    ...
    public AmqpShred() {
        super(new SqlTableBase(AMQP_TBL_NAME, AMQP_TBL_CREATE_SQL, AMQP_TBL_INDEX_SQLS, AMQP_TBL_COLUMNS),
   ...
   // Shred table "amqp" (message queue)
    ...
    public static final String AMQP_TBL_CREATE_SQL =
            "create table amqp(" +
                    ...
                    "body text not null)";
    public static final List<String> AMQP_TBL_INDEX_SQLS =
