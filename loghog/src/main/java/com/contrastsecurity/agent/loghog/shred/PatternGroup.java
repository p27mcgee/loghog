...
public class PatternGroup {
    ...
    public static final String LOG_LEVEL_XTRACT =
    ...
    public static final String WARN_PREAMBLE_XTRACT =
            SHORT_PREAMBLE_XTRACT + LOG_LEVEL_WARN + " ";

    public static final String INFO_PREAMBLE_XTRACT =
            SHORT_PREAMBLE_XTRACT + LOG_LEVEL_INFO + " ";
    ...
    public static final String REQ_XTRACT =
        "request@(?<" + REQ_VAR + ">\\S+)";
    public static final String NO_REQ_XTRACT =
            "(?<" + REQ_VAR + ">~UNFOUND~)?";

    public static final String RESP_VAR = "resp";
    public static final String RESP_XTRACT =
            "response@(?<" + RESP_VAR + ">\\S+)";
    public static final String NO_RESP_XTRACT =
            "(?<" + RESP_VAR + ">~UNFOUND~)?";

    public static final String URL_VAR = "url";
    public static final String URL_XTRACT =
            "^(?<" + URL_VAR + ">\\S+)";
    public static final String NO_URL_XTRACT =
            "(?<" + URL_VAR + ">~UNFOUND~)?";

    public static final String STACKFRAME_VAR = "stackframe";
    public static final String NO_STACKFRAME_XTRACT =
            "(?<" + STACKFRAME_VAR + ">~UNFOUND~)?";
